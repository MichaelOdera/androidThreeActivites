...
public class FitnessLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Intent intent = new Intent(FitnessLoginActivity.this, MainActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    FitnessLoginActivity.this.startActivity(intent);
                    FitnessLoginActivity.this.finish();
                }
            }
        };
    ...
    public void onClick(View v) {
        if( v == mRegisterTextView){
            Intent registrationIntent = new Intent(FitnessLoginActivity.this, RegistrationAccountActivity.class);
